...
- [三、 硬體清單與接線對照表 (Pinout)](#三-硬體清單與接線對照表-pinout)
- [四、 專案目錄結構](#四-專案目錄結構)
- [五、 編譯與部署指南](#五-編譯與部署指南)
...
- [六、 MQTT 通訊協定與 JSON Payload 規範](#六-mqtt-通訊協定與-json-payload-規範)
- [七、 授權條款 (License)](#七-授權條款-license)
